...
RenderMe::RenderMe3D::LineRenderer* lineRenderer;
...
int main()
{
    ...
    TransformComponent tran = {3,0,3,5,5,2,2,2,2};
   // TransformComponent tran1 = {10,10,-10,5,5,2,2,2,2};
    TransformComponent tran2 = {0,0,0,5,5,2,2,2,2};
    //TransformComponent tran3 = {-10,-10,-10,5,5,2,2,2,2};
    //TransformComponent tran4 = {-10,10,-10,5,5,2,2,2,2};
    //TransformComponent tran5 = {-10,-10,10,5,5,2,2,2,2};
    ...
    lineRenderer = new RenderMe::RenderMe3D::LineRenderer(points,vertexShader,fragmentShader);
   ...
   // scene.addComponent(entity5, tran5);
    scene.addComponent(entity5, *lineRenderer);
    scene.addComponent(entity5, tran2);
    cam  =new RenderMe::RenderMe3D::Camera(&scene, { 0,0,0}, { 0,45,0 });
    int height, width;
